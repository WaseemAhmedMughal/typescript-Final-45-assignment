...
//pizza ka variable me array bana kar type defiande kar k value save kar wadi.
let pizzas:string[] = ['Pepproni','BBQ Chiken','Malai Boti']
// for of ka loop use kar k print karwaya.
for(let pizza of pizzas){
    console.log(`I Like ${pizza} Pizza.`);
    
}
console.log('I Rellay Love pizza');
