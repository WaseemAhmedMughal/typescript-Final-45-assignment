...
// Inequality test 2
console.log("Inequality test with strings: ", ("apple" as string) != "banan");
...
console.log("numerical inequality test: ", (10 as number) != 100 );
...
// Test whether an item is in a array
const fruit :string[] = ["Mango", "Water Melon", "Strawberry", "kiwi"];
